...
public class DictionaryControllerTest {
	...
	public void traslateWordsToValueTest() {
		...
		assertEquals("Error traslateWordsToValueTest", true,
				(dictionaryController.traslateWordsToValue("GLOP GLOP SPOK")));
	}

	@Test
	public void getValueOfProductTest() {
		log.log(Level.FINE, "getValueOfProductTest");
		assertEquals("Error getValueOfProductTest", true,
				(dictionaryController.getValueOfProduct("GLOP GLOP SPOK SILVER IS 930 CREDITS")));
	}
	...
	public void conversionQueryTest() {
		...
		assertEquals("Error conversionQueryTest", true,
				(dictionaryController.conversionQuery("HOW MUCH IS GLOP GLOP SPOK ?")));
	}

	@Test
	public void productQueryTest() {
		log.log(Level.FINE, "productQueryTest");
		assertEquals("Error productQueryTest", true,
				(dictionaryController.productQuery("HOW MANY CREDITS IS GLOP GLOP SPOK SILVER ?")));
	}
}
